...
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"flip-container\" (click)=\"flip()\" [class.flipped]=\"flipped\">\n\n  <div class=\"flipper\">\n\n\n    <div class=\"front\">\n\n\n      <ng-content select=\".flash-card-front\"></ng-content>\n\n    </div>\n\n    <div class=\"back\">\n\n      <ng-content select=\".flash-card-back\"></ng-content>\n\n    </div>\n\n  </div>\n\n</div>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FastComponent", function() { return FastComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");


let FastComponent = class FastComponent {
    constructor() {
        this.flipped = false;
    }
    ngOnInit() { }
...
FastComponent.ctorParameters = () => [];
FastComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-fast',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./fast.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/Components/fast/fast.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./fast.component.scss */ "./src/app/Components/fast/fast.component.scss")).default]
    })
], FastComponent);
...
/* harmony import */ var _fast_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./fast.component */ "./src/app/Components/fast/fast.component.ts");




let FastModule = class FastModule {
};
FastModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
/* harmony import */ var _Components_fast_fast_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../Components/fast/fast.module */ "./src/app/Components/fast/fast.module.ts");
/* harmony import */ var _flash_flash_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../flash/flash.module */ "./src/app/flash/flash.module.ts");
...
FolderPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _Components_fast_fast_module__WEBPACK_IMPORTED_MODULE_7__["FastModule"],
            _flash_flash_module__WEBPACK_IMPORTED_MODULE_8__["FlashPageModule"],
        ],
...
/* harmony import */ var _Components_add_subject_add_subject_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../Components/add-subject/add-subject.component */ "./src/app/Components/add-subject/add-subject.component.ts");
/* harmony import */ var _Shared_index_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../Shared/index.service */ "./src/app/Shared/index.service.ts");
...
let FolderPage = class FolderPage {
    constructor(activatedRoute, popoverController, modalctrl, indexser) {
    ...
    ngOnInit() {
        this.getCourses();
        this.socket.on('refreshgettingCourse', (data) => {
            this.getCourses();
        });
    }
    getCourses() {
        this.indexser.getCourse().subscribe((res) => {
            console.log(res);
    ...
    removeFromarray(id) {
        this.maths = this.maths.filter((el) => {
            return el.id != id;
        });
    }
    presentModal() {
