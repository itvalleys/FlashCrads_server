  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["Pages-conceptData-levels-module"], {
    ...
    function srcAppPagesConceptDataLevelsModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      LevelsPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _levels_routing_module__WEBPACK_IMPORTED_MODULE_5__["LevelsPageRoutingModule"], _swimlane_ngx_datatable__WEBPACK_IMPORTED_MODULE_7__["NgxDatatableModule"]],
        ...
        _createClass(LevelsPage, [{
          ...
          value: function getQuestionsData(id) {
            ...
            this.indexser.getQuestionsData(id).subscribe(function (res) {
              _this27.qnA = res.record[0].QnA;
              console.log(_this27.qnA);
              _this27.qdata = res.record[0];
            }, function (err) {
              console.log(err);
            });
          }
          ...
          value: function _delete(qid) {
            ...
            this.indexser.deleteoneQue(qid).subscribe(function (res) {
              ...
              _this28.getQuestionsData(_this28.id);
            }, function (err) {
              console.log(err);
            });
          }
