...
let EditquestionComponent = class EditquestionComponent {
    ...
    editSingleQue() {
        ...
        this.indexservice.editSingleQnA(editdata).subscribe((res) => {
            console.log(res);
        }, (err) => {
            console.log(err);
        });
...
EditquestionComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-editquestion',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./editquestion.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/Components/editquestion/editquestion.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./editquestion.component.scss */ "./src/app/Components/editquestion/editquestion.component.scss")).default]
    })
...
/* harmony import */ var _levels_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./levels.page */ "./src/app/Pages/conceptData/levels.page.ts");
...
/* harmony import */ var _levels_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./levels-routing.module */ "./src/app/Pages/conceptData/levels-routing.module.ts");
/* harmony import */ var _levels_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./levels.page */ "./src/app/Pages/conceptData/levels.page.ts");
...
/* harmony import */ var src_app_Shared_index_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/Shared/index.service */ "./src/app/Shared/index.service.ts");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/__ivy_ngcc__/fesm2015/ionic-angular.js");
/* harmony import */ var _Components_editquestion_editquestion_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../Components/editquestion/editquestion.component */ "./src/app/Components/editquestion/editquestion.component.ts");
...
let LevelsPage = class LevelsPage {
    constructor(activatedRoute, indexser, modalctrl) {
    ...
    // }
    getQuestionsData(id) {
        this.indexser.getQuestionsData(id).subscribe((res) => {
            this.qnA = res.record[0].QnA;
            console.log(this.qnA);
            this.qdata = res.record[0];
        }, (err) => {
            console.log(err);
        });
    }
    delete(qid) {
        ...
        console.log('delete');
        this.indexser.deleteoneQue(qid).subscribe((res) => {
            console.log(res);
            this.getQuestionsData(this.id);
        }, (err) => {
            console.log(err);
...
LevelsPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-levels',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./levels.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/Pages/conceptData/levels.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./levels.page.scss */ "./src/app/Pages/conceptData/levels.page.scss")).default]
    })
], LevelsPage);
...
//# sourceMappingURL=Pages-conceptData-levels-module-es2015.js.map